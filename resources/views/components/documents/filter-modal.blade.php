            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium mb-1">Document Type</label>
                        ...
                        <option value="Daily Time Record">Daily Time Record (DTR)</option>
                        ...
                        <option value="Document Registration/ Revision Form">Document Registration/ Revision Form(DRR)</option>
                        ...
                        <option value="Notice of Finality of Decision">Notice of Finality of Decision (NFD)</option>
                        <option value="Notice of Salary Adjustment">Notice of Salary Adjustment (NOSA)</option>
                        <option value="Notice of Step Increment">Notice of Step Increment (NOSI)</option>
                        <option value="Obligation">Obligation (ORS)</option>
                        ...
                        <option value="Performance and Commitment Review">Performance and Commitment Review (PCR)</option>
                        <option value="PPMP">PPMP</option>
                        <option value="Program of Works">Program of Works (POW)</option>
                        ...
                        <option value="Statement of Account">Statement of Account (SOA)</option>
